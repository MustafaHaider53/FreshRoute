      ...
      <main className="main-content">
        <div className="glass card animate-fade" style={{ padding: '40px', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
            Welcome, <strong>{user?.name}</strong>! This module is assigned to <strong>Faraz</strong> and <strong>Ammar</strong>.
          </p>
          <div className="alert alert-success" style={{ maxWidth: '500px', margin: '0 auto' }}>
            It will contain the produce catalogue, shopping cart checkout, WebSocket order updates, and AI quality disputes.
          </div>
        </div>
      </main>
    </div>
